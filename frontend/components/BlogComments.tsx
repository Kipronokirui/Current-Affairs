          ...
          <div>
              {comments?.map((comment) => (
                        ...
                        <div className="flex items-center">
                            <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                <img
                                    ...
                                    src={comment.commentOwner.profile_image}
                                    alt="Michael Gough"
                                />
                ...
                {comment.replies?.map((reply) => (
                    <section>
                        <article key={reply.id} className="p-6 mb-2 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
                            <footer className="flex justify-between items-center mb-2">
                                <div className="flex items-center">
                                    <p className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                                        <img
                                            className="mr-2 w-6 h-6 rounded-full"
                                            src={reply.replied_by.profile_image}
                                            alt="Jese Leos"
                                        />
                                        {reply.replied_by.name}
                                    </p>
                                    <p className="text-sm text-gray-600 dark:text-gray-400"><time dateTime="2022-02-12"
                                        title="February 12th, 2022">{reply.date }</time></p>
                                </div>
